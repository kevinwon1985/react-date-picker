...
var DayCell = function (_Component) {
	...
	function DayCell(props) {
		...
		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DayCell).call(this, props));
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'span',
				{
					...
					style: _extends({}, styles['Cell'], styles[cellStyleKey], stateStyle), __self: this
				},
				this.props.children
			);
		}
