	...
	_createClass(Calendar, [{
		...
		value: function renderHeader(title) {
			...
			return _react2.default.createElement(
				'div',
				{ style: styles['Header'], className: 'rdr-header-inner', __self: this
				},
				_react2.default.createElement(
					'button',
					{
						...
						onClick: this.transitionBtnClickHandle.bind(this, -1), __self: this
					},
					_react2.default.createElement('i', { style: _extends({}, styles['TransitionBtnArrow'], styles['TransitionBtnArrowPrev']), __self: this
					})
				),
				_react2.default.createElement(
					'span',
					{ className: 'rdr-header-title',
						...
						style: _extends({}, styles['HeaderTitle']), __self: this
					},
					title
				),
				_react2.default.createElement(
					...
					_react2.default.createElement('i', { style: _extends({}, styles['TransitionBtnArrow'], styles['TransitionBtnArrowNext']), __self: this
					})
				)
			);
		}
		...
		value: function renderWeekdays() {
			...
			for (var i = dow; i < 7 + dow; i++) {
				...
				weekdays.push(_react2.default.createElement(
					'span',
					{ style: styles['Weekday'], className: 'rdr-WeekDay', key: day, __self: this
					},
					day
				));
			}
		...
		value: function renderDayView() {
			...
			return _react2.default.createElement(
				'div',
				{ style: _extends({}, styles['Calendar'], this.props.style), className: 'rdr-Calendar', __self: this
				},
				'//TODO: 待实现'
			);
		}
		...
		value: function renderMonthView() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'rdr-header', __self: this
					},
					this.renderHeader(headerTitle)
				),
				_react2.default.createElement(
					'div',
					{ className: 'rdr-body', __self: this
					},
					_react2.default.createElement(
						'div',
						{ className: 'rdr-WeekDays', __self: this
						},
						this.renderWeekdays()
					),
					_react2.default.createElement(
						'div',
						{ className: 'rdr-Days', __self: this
						},
						this.renderDays()
					)
				)
