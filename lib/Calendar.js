...
function checkRangex(dayMoment, rangex) {
	return dayMoment.isBetween((0, _moment2.default)(rangex['rangeMindate']).clone().startOf('days'), (0, _moment2.default)(rangex['rangeMaxdate']).clone().add(1, 'days'));
}
...
var Calendar = function (_Component) {
	...
	function Calendar(props) {
		...
		var rangeMindate = props.rangeMindate;
		var rangeMaxdate = props.rangeMaxdate;
		...
		var state = {
			...
			shownDate: (dates && rangeMindate && rangeMaxdate && dates['endDate'] || dates || (0, _moment2.default)()).clone(),
	...
	_createClass(Calendar, [{
		...
		value: function componentWillReceiveProps(nextProps) {
			...
			var rangeMindate = nextProps.rangeMindate;
			var rangeMaxdate = nextProps.rangeMaxdate;
			...
			switch (selectMode) {
				...
				case _constants.SELECTMODE.DATEX:
					shownDate = (rangeMindate || (0, _moment2.default)()).clone();
					viewMode = selectMode >> 2 << 2;
					break;
		...
		value: function renderDays() {
			...
			var rangeMindate = _state4.rangeMindate;
			var rangeMaxdate = _state4.rangeMaxdate;
			...
			return days.map(function (data, index) {
				...
				switch (selectMode) {
					...
					case _constants.SELECTMODE.DATE:
						...
						break;
					case _constants.SELECTMODE.DATEX:
						var rangex = { rangeMindate: rangeMindate, rangeMaxdate: rangeMaxdate };
